...
export default function Welcome() {
    ...
    return (
        <div
            className="transition-all flex-1 flex flex-col items-center justify-center py-10"
            style={{
                opacity: opacity,
        ...
        >
            ...
            <p className="text-gray-600">Lets get on with some configuration</p>

            <div
                className="w-[50%] max-w-[380px] mt-2 transition-opacity"
                style={{ opacity: animate ? 100 : 0, transitionDuration: "1s" }}
            >
                <Input
                    id={"You name"}
                    labelTitle={
